...
if uploaded_file:
    ...
    df_valid.to_excel(export_buffer, index=False, sheet_name="Processed Data")
    export_buffer.seek(0)
    st.download_button("📥 Download Processed Data", export_buffer, file_name=f"{generate_unique_filename()}.xlsx")
